...
cmd:option('-trainingSetLMDBPath', './prepare_datasets/equ_lmdb/train/', 'Path to LMDB training dataset')
cmd:option('-validationSetLMDBPath', './prepare_datasets/equ_lmdb/test/', 'Path to LMDB test dataset')
...
cmd:option('-validationBatchSize', 11, 'Batch size for validation')
